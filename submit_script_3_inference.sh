...
srun python s3_write_predictions_conditional_pixel_diffusion.py +data.template=$TemplateName +experiment=$ExperimentName +model_name=$ModelID +n_ensemble_members=$EnsembleMembers
